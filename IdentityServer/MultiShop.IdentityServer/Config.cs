    ...
    public static class Config
    {
        ...
        public static IEnumerable<Client> Clients => new Client[]
      {
            ...
            new Client
            {
                ...
                ClientSecrets={new Secret("multishopsecret".Sha256()) },
                AllowedScopes={ "BasketFullPermission","CatalogReadPermission", "CatalogFullPermission", "OcelotFullPermission", "CommentFullPermission", "ImageFullPermission","DiscountFullPermission","OrderFullPermisson","MessageFullPermission","CargoFullPermission",
